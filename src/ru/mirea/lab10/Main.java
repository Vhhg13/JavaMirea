...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        students[0]=new Student10("FirstName1", "LastName5", "Speciality1", 2, "Group2");
        students[1]=new Student10("FirstName2", "LastName4", "Speciality3", 4, "Group3");
        students[2]=new Student10("FirstName3", "LastName3", "Speciality5", 5, "Group5");
        students[3]=new Student10("FirstName4", "LastName2", "Speciality4", 3, "Group1");
        students[4]=new Student10("FirstName5", "LastName1", "Speciality2", 1, "Group4");
